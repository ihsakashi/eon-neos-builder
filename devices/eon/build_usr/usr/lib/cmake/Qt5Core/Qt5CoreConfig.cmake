...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/qt/QtCore/5.13.0"
        "${_qt5Core_install_prefix}/include/qt/QtCore/5.13.0/QtCore"
    )
    ...
    set_property(TARGET Qt5::Core PROPERTY INTERFACE_QT_DISABLED_FEATURES cxx11_future;sharedmemory;systemsemaphore)
    ...
    macro(_populate_Core_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Core_install_prefix}/libexec/qt/${PLUGIN_LOCATION}")
        _qt5_Core_check_file_exists(${imported_location})
