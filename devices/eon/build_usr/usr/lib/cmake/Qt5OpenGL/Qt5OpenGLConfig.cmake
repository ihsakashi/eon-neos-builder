...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/qt/QtOpenGL/5.13.0"
        "${_qt5OpenGL_install_prefix}/include/qt/QtOpenGL/5.13.0/QtOpenGL"
    )
    ...
    macro(_populate_OpenGL_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5OpenGL_install_prefix}/libexec/qt/${PLUGIN_LOCATION}")
        _qt5_OpenGL_check_file_exists(${imported_location})
