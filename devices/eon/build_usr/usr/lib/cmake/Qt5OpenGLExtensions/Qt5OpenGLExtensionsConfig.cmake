...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    set(_Qt5OpenGLExtensions_MODULE_DEPENDENCIES "Widgets;Gui;DBus;Core")
    ...
    set(_Qt5OpenGLExtensions_LIB_DEPENDENCIES "Qt5::Widgets;Qt5::Gui;Qt5::DBus;Qt5::Core")
    ...
    macro(_populate_OpenGLExtensions_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5OpenGLExtensions_install_prefix}/libexec/qt/${PLUGIN_LOCATION}")
        _qt5_OpenGLExtensions_check_file_exists(${imported_location})
