...
if (NOT TARGET Qt5::Test)
    ...
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/qt/QtTest/5.13.0"
        "${_qt5Test_install_prefix}/include/qt/QtTest/5.13.0/QtTest"
    )
    ...
    macro(_populate_Test_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Test_install_prefix}/libexec/qt/${PLUGIN_LOCATION}")
        _qt5_Test_check_file_exists(${imported_location})
