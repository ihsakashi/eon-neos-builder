...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/qt/QtNetwork/5.13.0"
        "${_qt5Network_install_prefix}/include/qt/QtNetwork/5.13.0/QtNetwork"
    )
    ...
    macro(_populate_Network_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Network_install_prefix}/libexec/qt/${PLUGIN_LOCATION}")
        _qt5_Network_check_file_exists(${imported_location})
