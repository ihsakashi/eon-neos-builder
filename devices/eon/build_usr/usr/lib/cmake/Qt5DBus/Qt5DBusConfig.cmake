...
macro(_populate_DBus_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::DBus PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5DBus.so"
...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/qt/QtDBus/5.13.0"
        "${_qt5DBus_install_prefix}/include/qt/QtDBus/5.13.0/QtDBus"
    )
    ...
    _populate_DBus_target_properties(RELEASE "libQt5DBus.so" "" )
    ...
    macro(_populate_DBus_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5DBus_install_prefix}/libexec/qt/${PLUGIN_LOCATION}")
        _qt5_DBus_check_file_exists(${imported_location})
